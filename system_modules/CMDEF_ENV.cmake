...
MACRO(_CMDEF_ENV_SET_OS)
	...
	IF(NOT CMDEF_ARCHITECTURE)
		...
		ELSEIF(NOT "$ENV{CMDEF_ARCHITECTURE}" STREQUAL "")
...
FUNCTION(_CMDEF_ENV_GET_ARCH arch)
	...
	IF(CMDEF_OS_LINUX)
		...
		IF(NOT (result EQUAL 0))
			MESSAGE(FATAL_ERROR "Cannot determine architecture! Set up CMDEF_ARCHITECTURE od CMAKE_SYSTEM_PROCESSOR manually or repair uname")
		ENDIF()
