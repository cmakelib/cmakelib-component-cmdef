...
FUNCTION(CMDEF_PACKAGE)
	...
	IF(NOT TARGET ${__MAIN_TARGET})
		MESSAGE(FATAL_ERROR "Not a valid CMake target: ${__MAIN_TARGET}.")
	ENDIF()
	...
	IF(DEFINED cmdef_library OR DEFINED cmdef_executable)
		_CMDEF_PACKAGE_FIND_AND_CHECK_DEPENDENCIES(
				...
				OUTPUT_DEPENDENCIES_LIST CMDEF_PACKAGE_TARGETS_TO_INCLUDE
		)
		LIST(APPEND CMDEF_PACKAGE_TARGETS_TO_INCLUDE ${__MAIN_TARGET})
		_CMDEF_PACKAGE_CHECK_NAMESPACE(${__MAIN_TARGET} "${CMDEF_PACKAGE_TARGETS_TO_INCLUDE}")
	ELSE()
		LIST(APPEND CMDEF_PACKAGE_TARGETS_TO_INCLUDE ${__MAIN_TARGET})
	ENDIF()
