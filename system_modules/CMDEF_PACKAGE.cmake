...
FUNCTION(CMDEF_PACKAGE)
	...
	IF(DEFINED CMAKE_BUILD_TYPE)
		...
		SET(CPACK_PACKAGE_FILE_NAME "${output_name}_v${__VERSION}_${CMDEF_OS_NAME}-${CMDEF_ARCHITECTURE}" PARENT_SCOPE)
	ELSE()	
		SET(CPACK_OUTPUT_CONFIG_FILE "${config_file}" PARENT_SCOPE)
		SET(package_name_rule "$<TARGET_FILE_BASE_NAME:${__MAIN_TARGET}>")
		SET(package_filename  "${package_name_rule}_v${__VERSION}_${CMDEF_OS_NAME}-${CMDEF_ARCHITECTURE}")
